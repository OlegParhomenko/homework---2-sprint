...
export const pureAddUser = (name: string, setError: React.Dispatch<React.SetStateAction<string>>, setName: React.Dispatch<React.SetStateAction<string>>, addUserCallback: any) => {
   if(name.trim() === ''){
...
export const pureOnBlur = (name: string, setError: React.Dispatch<SetStateAction<string>>) => {
    if(name.trim() === ''){
        setError("Ошибка! Введите имя!")
    }
    //
